<?php
    return [
        'posts_by_user'=> 'select a.pid, a.title, DATE_FORMAT(a.created_at, "%M %d, %Y") created_at, a.subject, b.visible, b.is_approved approved from post_detail a, post_master b where a.pid = b.pid and b.author = :AUTHOR and b.deleted = :DELETED order by a.created_at desc',
        'getpost'=> 'select a.*, b.author, b.approved_by, b.visible, b.is_approved from post_detail a, post_master b where a.pid= :PID and a.pid = b.pid and b.is_approved= :APPRV and b.deleted = :DEL',
        ...
        'getUserData' => 'select name, email from users where id = :USERID'
    ];
?>