<?php
    return [
        ...
        'getpost'=> 'select a.*, b.author, b.approved_by, b.visible from post_detail a, post_master b where a.pid= ? and a.pid = b.pid and b.visible = ? and b.is_approved= ? and b.deleted = ?',
        'get_author_post' => 'select a.*, b.author, b.approved_by, b.visible from post_detail a, post_master b where a.pid= ? and a.pid = b.pid',
